#!/usr/bin/env python3
"""
Controlled Experiment Runner for System Prompt Protection (V2)

Runs systematic experiments across:
- 4 base models × 3 protection levels = 12 variants
- Representative low-level skills: L14, L7, L1, L6, L2
- Representative high-level patterns: H5, H9

Usage:
    # Run full experiment suite
    python run_controlled_exp_v2.py --full

    # Run quick validation (1 skill × 12 models)
    python run_controlled_exp_v2.py --quick

    # Run specific skill across all models
    python run_controlled_exp_v2.py --skill L14

    # Run specific model variant only
    python run_controlled_exp_v2.py --model "openai/gpt-5.2:none-defense"
"""
